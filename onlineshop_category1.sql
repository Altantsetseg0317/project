...
CREATE TABLE `category1` (
  ...
  `fantasy` varchar(45) NOT NULL,
  `funny` varchar(45) NOT NULL,
  `best` varchar(45) NOT NULL,
  `top seller` varchar(45) NOT NULL,
  PRIMARY KEY (`category_id`,`name`,`romance`,`normal`,`fantasy`,`funny`,`best`,`top seller`)
...
-- Dump completed on 2024-05-29 13:17:16
